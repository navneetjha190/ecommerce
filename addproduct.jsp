	...
	<br>
	 ...
	 <div class="container border">
		...
		<%
			...
			<div class="k"><h6><b><input type=file name="pimage2"  ></b></h6></div>
			
			<div class="m"><h6><b><input type=file name="pimage3"  ></b></h6></div>
			<div class="n"><h6><b><input type=file name="pimage4"  ></b></h6></div>
	    	<div class="o"><h6><b><input type=file name="pimage5"  ></b></h6></div>
			<div class="p"><h6><b><input type=file name="pimage6"  ></b></h6></div>
